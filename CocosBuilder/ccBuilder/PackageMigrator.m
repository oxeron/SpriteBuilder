...
- (NSError *)standardError
{
    NSString *message = [NSString stringWithFormat:@
            ...
            "The project will be opened as usual, however you can help us by creating an <a href=\"https://github.com/cocosbuilder/CocosBuilder/issues/new\">issue on github</a> and posting the content of the log, see below. "
