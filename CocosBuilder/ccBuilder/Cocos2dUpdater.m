...
@property (nonatomic, copy) NSString *CocosBuildersCocos2dVersion;
...
- (void)updateAndBypassIgnore:(BOOL)bypassIgnore
{
    ...
    {
        LocalLog(@"[COCO2D-UPDATER] [INFO] Ignoring this version %@.", self.CocosBuildersCocos2dVersion);
        return;
    }
    ...
    {
        LocalLog(@"[COCO2D-UPDATER] [INFO] Now ignoring this version %@.", self.CocosBuildersCocos2dVersion);
...
- (void)doUpdate
{
    ...
    dispatch_async(queue, ^
    {
        ...
        BOOL updateResult = [self unzipProjectTemplateZip:&error]
            ...
            && [self copyCocosBuildersCocos2dFolderToProjectFolder:&error]
		...
		if (updateResult)
		{
			[CCBFileUtil cleanupCocosBuilderProjectAtPath:_projectSettings.projectPath];
		}
...
{
	// SI: added check for _CocosBuildersCocos2dVersion being nil - happens if you click "Ignore this version" (at least in dev builds)
    if (self.CocosBuildersCocos2dVersion
        && ![_projectSettings.cocos2dUpdateIgnoredVersions containsObject:self.CocosBuildersCocos2dVersion])
    {
        [_projectSettings.cocos2dUpdateIgnoredVersions addObject:self.CocosBuildersCocos2dVersion];
    }
}

- (BOOL)shouldIgnoreThisVersion
{
    return [_projectSettings.cocos2dUpdateIgnoredVersions containsObject:self.CocosBuildersCocos2dVersion];
}
...
- (BOOL)copyCocosBuildersCocos2dFolderToProjectFolder:(NSError **)error
{
...
- (UpdateActions)showUpdateDialogWithText:(NSString *)text
{
    ...
    {
        [informativeText appendFormat:@"\n\nUpdate to version %@?", self.CocosBuildersCocos2dVersion];
    }
...
- (Cocos2dVersionComparisonResult)compareProjectsCocos2dVersionWithCocosBuildersVersion
{
    LocalLog(@"[COCO2D-UPDATER] [INFO] Comparing version - SB: %@ with project: %@ ...", self.CocosBuildersCocos2dVersion, self.projectsCocos2dVersion);
	...
	SemanticVersioning * sbVersion = [[SemanticVersioning alloc] initWithString:self.CocosBuildersCocos2dVersion];
