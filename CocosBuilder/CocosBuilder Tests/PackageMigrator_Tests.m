...
- (void)testMigrationStandardCaseNoPackageFolderNoPackages
{
    [self createEmptyFiles:@[
            @"CocosBuilder Resources/asset.png",
            @"CocosBuilder Resources/scene.ccb"]];

    [self setProjectsResourcePaths:@[@"CocosBuilder Resources"]];
    ...
    [self assertFileDoesNotExist:@"CocosBuilder Resources"];
    [self assertFileExists:[@"packages/CocosBuilder Resources" stringByAppendingPackageSuffix]];
    [self assertFileExists:[[@"packages/CocosBuilder Resources" stringByAppendingPackageSuffix] stringByAppendingPathComponent:@"asset.png"]];
    [self assertResourcePathsInProject:@[[_projectSettings fullPathForPackageName:@"CocosBuilder Resources"]]];
    [self assertResourcePathsNotInProject:@[[self fullPathForFile:@"CocosBuilder Resources"]]];
}
...
- (void)testRollback
{
    ...
    [self assertFileExists:@"CocosBuilder Resources/asset.png"];
    [self assertFileExists:@"CocosBuilder Resources/scene.ccb"];
    [self assertFileDoesNotExist:@"packages"];
    [self assertResourcePathsInProject:@[[self fullPathForFile:@"CocosBuilder Resources"]]];
