...
{
    XCTAssertEqual(kCCBVersion, kCCBXVersion, @"CCB version %d read by CCBReader is incompatible with version %d written by CocosBuilder. Is cocos2d up to date?", kCCBVersion, kCCBXVersion);
}
