...
This is a description of the CocosBuilder export (publish) file format for Cocos2d. It is a binary file format designed to be as compact as possible and very quick to load. This document covers version 4 of the ccbi file format, released with CocosBuilder 1. If you are implementing or porting a reader for the ccbi file format, you may want to also have a look at the CCBReader, which is the reference implementation.
